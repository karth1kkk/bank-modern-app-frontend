    ...
    <section id='product' className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          ...
          Alias soluta ab sint, nemo qui modi officiis, nihil officia 
          numquam quibusdam dolorum ipsa dignissimos accusantium 
          molestias repudiandae eum! Saepe, iure enim.
        </p>
